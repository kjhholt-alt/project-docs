...
| LLM Benchmark Suite | `llm-benchmark-suite/` | **North star (Kruz !ok 2026-07-03): the reference lab for agentic token economics** — TPVS metric, router calibration live; standard-benchmark/judge coverage is the calibration substrate | **Phase 2 in progress** (router calibration governing real dispatch) | [NORTH-STAR.md](../llm-benchmark-suite/docs/NORTH-STAR.md) · [STATUS.md](../llm-benchmark-suite/STATUS.md) |
