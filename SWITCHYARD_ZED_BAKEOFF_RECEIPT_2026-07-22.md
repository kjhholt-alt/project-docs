...
- Twenty `unittest` cases passed, including visible supporting-warning behavior, truthful shadow-history aggregation, and launcher-argument coverage against Zed's installed CLI help.
- Ruff passed.
